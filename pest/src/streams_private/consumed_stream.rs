...
pub struct ConsumedStream<R: RuleType, I: Input, S: TokenStream<R, I>> {
...
impl<R: RuleType, I: Input, S: TokenStream<R, I>> ConsumedStream<R, I, S> {
    #[inline]
...
impl<R: RuleType, I: Input, S: TokenStream<R, I>> Stream for ConsumedStream<R, I, S> {
    type Item  = Token<R, I>;
